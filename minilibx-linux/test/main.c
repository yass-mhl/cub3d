...
int	main()
{
  ...
  mlx_key_hook(win1,KEYWin1,0);
  mlx_expose_hook(win2,expose_win2,0);
  mlx_mouse_hook(win2,mouse_win2,0);
  mlx_key_hook(win2,KEYWin2,0);
  mlx_key_hook(win3,KEYWin3,0);
