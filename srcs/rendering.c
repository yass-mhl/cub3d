...
int key_press(int keycode, void *param)
{
    ...
    printf("map details: posX=%f, posY=%f, dirX=%f, dirY=%f, planeX=%f, planeY=%f\n",
        map->posX, map->posY, map->dirX, map->dirY, map->planeX, map->planeY);
    printf("Key pressed: %d\n", keycode);
	printf("Drawing scene...\n");
	draw_scene(map->map, map->mlx, map->mlx_win, map->mlx_img);
	printf("Scene drawn.\n");
    return (0);
}
